...
<aside class="app-sidebar">
  ...
  <ul class="app-menu">
    <li><a class="app-menu__item" href="list_users.php"><i class="app-menu__icon bi bi-code-square"></i><span
    class="app-menu__label">Usuarios</span></a></li>
    <li><a class="app-menu__item" href="list_teachers.php"><i class="app-menu__icon bi bi-code-square"></i><span
    ...
    <li><a class="app-menu__item" href="list_degrees.php"><i class="app-menu__icon bi bi-code-square"></i><span
    ...
    <li><a class="app-menu__item" href="list_periods.php"><i class="app-menu__icon bi bi-code-square"></i><span
    class="app-menu__label">Periodos</span></a></li>
    <li><a class="app-menu__item" href="list_activities.php"><i class="app-menu__icon bi bi-code-square"></i><span
